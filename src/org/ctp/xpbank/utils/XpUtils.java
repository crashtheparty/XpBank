...
public class XpUtils {
	...
	/**
	 * Modify the player's levels and return the amount to add or remove from the
	 * bank
	 * 
	 * @param player
	 *            - the player
	 * @param toChange
	 *            - the amount of experience the player should have at the end
	 * @param inBank
	 *            - the amount of experience the player has in the bank
